    ...
    <div className='px-4 py-6 space-y-8'>
      <div className='flex flex-wrap items-center justify-between gap-2'>
        ...
        <div className='space-x-2'>
          {priority && (
            <span className='px-3 text-sm font-semibold tracking-wide uppercase bg-red-500 rounded-full text-red-50'>
              Priority
            </span>
          )}
          <span className='px-3 text-sm font-semibold tracking-wide uppercase bg-green-500 rounded-full text-green-50'>
            {status} order
          </span>
        </div>
      </div>
